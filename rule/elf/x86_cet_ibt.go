...
func (r X86CETIBTRule) Execute(bin elf.Binary) rule.Result {
	hasIBT, err := elf.HasGNUProperty(bin, elf.GNU_PROPERTY_X86_FEATURE_1_AND, elf.GNU_PROPERTY_X86_FEATURE_1_IBT)
	if err != nil {
