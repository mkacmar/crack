...
func TestNoInsecureRPATHRule(t *testing.T) {
	e2e.RunRuleTests(t, "no-insecure-rpath", []e2e.TestCase{
		...
		{Binary: "riscv64-gcc-no-rpath", Expect: e2e.Pass},
		{Binary: "riscv64-gcc-rpath-absolute", Expect: e2e.Pass},
		{Binary: "riscv64-gcc-rpath-multiple-absolute", Expect: e2e.Pass},
		{Binary: "riscv64-gcc-rpath-dot", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-dotdot", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-relative", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-parent-relative", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-tmp", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-var-tmp", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-tmp-subdir", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-empty-component", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-mixed", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-bare-relative", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-subdir-relative", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-origin-relative", Expect: e2e.Pass},
		{Binary: "riscv64-gcc-rpath-origin-parent", Expect: e2e.Fail},
		{Binary: "riscv64-gcc-rpath-dev-shm", Expect: e2e.Fail},

		{Binary: "riscv64-clang-no-rpath", Expect: e2e.Pass},
		{Binary: "riscv64-clang-rpath-absolute", Expect: e2e.Pass},
