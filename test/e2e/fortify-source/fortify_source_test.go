...
func TestFortifySourceRule(t *testing.T) {
	e2e.RunRuleTests(t, "fortify-source", []e2e.TestCase{
		...
		{Binary: "x86_64-gcc-fortify2-O0", Expect: e2e.Fail}, // -O0 disables fortify optimization
		{Binary: "x86_64-gcc-fortify2-stripped", Expect: e2e.Pass},
		{Binary: "x86_64-gcc-fortify2-static", Expect: e2e.Pass},
		{Binary: "x86_64-gcc-fortify2-static-stripped", Expect: e2e.Skip}, // no symbols to analyze
		{Binary: "x86_64-gcc-fortify2-lto", Expect: e2e.Pass},
		{Binary: "x86_64-gcc-fortify2-simple", Expect: e2e.Skip}, // no fortifiable functions

		// x86_64 Clang
		{Binary: "x86_64-clang-fortify2-O2", Expect: e2e.Pass},
		{Binary: "x86_64-clang-fortify1-O1", Expect: e2e.Pass},
		{Binary: "x86_64-clang-no-fortify", Expect: e2e.Fail},  // no fortify enabled
		{Binary: "x86_64-clang-fortify2-O0", Expect: e2e.Fail}, // -O0 disables fortify optimization
		...
		{Binary: "aarch64-gcc-fortify2-O0", Expect: e2e.Fail}, // -O0 disables fortify optimization
		{Binary: "aarch64-gcc-fortify2-stripped", Expect: e2e.Pass},
		{Binary: "aarch64-gcc-fortify2-static", Expect: e2e.Pass},
		{Binary: "aarch64-gcc-fortify2-static-stripped", Expect: e2e.Skip}, // no symbols to analyze
		{Binary: "aarch64-gcc-fortify2-lto", Expect: e2e.Pass},
		{Binary: "aarch64-gcc-fortify2-simple", Expect: e2e.Skip}, // no fortifiable functions

		// aarch64 Clang
		{Binary: "aarch64-clang-fortify2-O2", Expect: e2e.Pass},
		{Binary: "aarch64-clang-fortify1-O1", Expect: e2e.Pass},
		{Binary: "aarch64-clang-no-fortify", Expect: e2e.Fail},  // no fortify enabled
		{Binary: "aarch64-clang-fortify2-O0", Expect: e2e.Fail}, // -O0 disables fortify optimization
		...
		{Binary: "armv7-gcc-fortify2-static", Expect: e2e.Fail},          // static - can't detect musl, has unfortified funcs
		{Binary: "armv7-gcc-fortify2-static-stripped", Expect: e2e.Skip}, // no symbols to analyze
		{Binary: "armv7-gcc-fortify2-lto", Expect: e2e.Skip},
		{Binary: "armv7-gcc-fortify2-simple", Expect: e2e.Skip}, // no fortifiable functions
